...
if settings.ENVIRONMENT=="DEVELFO":
    urlpatterns += patterns('',
        url(r'^css/(?P<path>.*)$', 'django.views.static.serve', {
            'document_root': "/home/diacritica/GIT/emcodex/codex/templates/web/css/",
        }),
        url(r'^ima/(?P<path>.*)$', 'django.views.static.serve', {
            'document_root': "/home/diacritica/GIT/emcodex/codex/templates/web/ima/",
        }),
        url(r'^js/(?P<path>.*)$', 'django.views.static.serve', {
            'document_root': "/home/diacritica/GIT/emcodex/codex/templates/web/js/",
        }),
        url(r'^rotativo/(?P<path>.*)$', 'django.views.static.serve', {
            'document_root': "/home/diacritica/GIT/emcodex/codex/templates/web/rotativo/",
        }),
        url(r'^media/img/(?P<path>.*)$', 'django.views.static.serve', {
            'document_root': "/home/diacritica/GIT/emcodex/codex/media/img/",
        }),
        url(r'^media/files/(?P<path>.*)$', 'django.views.static.serve', {
            'document_root': "/home/diacritica/GIT/emcodex/codex/media/files/",
        }),
   )
